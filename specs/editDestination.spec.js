...
describe('Give I\'m at a random edit destination page', () => {
  ...
  describe('When I submit the form with less than the minimum required cgaracters', () => {
    beforeEach(() => {
      editDestination.form.submitFormAfterClearingAndFillingItWith('Ab', 'abcdefghi')
    })
    it('Then both input fields are wrapped in a .field_with-errors div', () => {
  ...
  describe('When successfuly submitting for the form with a new nam,e and decription', () => {
    let destinationUrl
    ...
    it('ThenI\'m redirected to the destination view page, and I see the updated info', () => {
